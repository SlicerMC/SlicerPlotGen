...
public class API {
    public static String getXposByPlayerID(UUID UUID) {
        HttpRequest request = HttpRequest.newBuilder()
                .uri(URI.create("http://127.0.0.1:8080/get_xpos_by_player_id?playerId=" + UUID))
    ...
    public static String getPlayerIDByXpos(String xpos) {
        HttpRequest request = HttpRequest.newBuilder()
                .uri(URI.create("http://127.0.0.1:8080/get_player_id_by_xpos?xpos=" + xpos))
                .method("GET", HttpRequest.BodyPublishers.noBody())
                .build();
    ...
    ///set_slice_owner_by_xpos
    public static String setSliceOwnerByXpos(UUID UUID, int xpos) {
        HttpRequest request = HttpRequest.newBuilder()
                .uri(URI.create("http://127.0.0.1:8080/set_slice_owner_by_xpos?xpos=" + xpos + "&playerId=" + UUID))
